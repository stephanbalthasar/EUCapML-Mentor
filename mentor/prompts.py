...
def build_tutor_messages(*,
    ...
    """
    system = (
      "If the USER QUERY contains no legal content (no legal terms, no MAR/WpHG/Prospekt etc., "
      "no §/Art./Article numbers, no case names, no financial facts, no scenario), "
      "then DO NOT give any legal explanation. Instead, give a brief, friendly greeting‑style reply "
      "and ask the user to state their legal question. "
